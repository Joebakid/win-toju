...
export default function HSE() {
  ...
  return (
    <section id="hse" ref={sectionRef} className="py-24 bg-white text-corporate-navy relative overflow-hidden">
      {/* Subtle Light Accent Background */}
      <div className="absolute top-0 right-0 w-1/2 h-full bg-slate-50/80 -skew-x-12 translate-x-32 z-0"></div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 space-y-16">
        ...
        <div className="max-w-3xl space-y-4">
          ...
          <h3 className="hse-header-anim opacity-0 text-3xl md:text-5xl font-black tracking-tight text-corporate-navy">
            Safety and Quality Are Not Negotiable
          </h3>
          <div className="hse-header-anim opacity-0 space-y-4 text-slate-600 text-base md:text-lg leading-relaxed pt-2">
            <p>
        ...
        <div className="hse-grid grid grid-cols-1 md:grid-cols-3 gap-8">
          {pillars.map((pillar, index) => (
            <div
              key={index}
              className="hse-card-anim opacity-0 bg-white border border-slate-200/80 p-8 rounded-2xl shadow-md hover:shadow-2xl hover:border-corporate-red transition-all duration-300 space-y-4 flex flex-col justify-between group"
            >
              <div className="space-y-4">
                ...
                <div>
                  <h4 className="text-2xl font-black text-corporate-navy group-hover:text-corporate-red transition-colors">
                    {pillar.title}
                  </h4>
        ...
        <div className="hse-header-anim opacity-0 pt-4">
          <Link
            href="/hse"
            className="inline-flex items-center gap-2 text-corporate-navy font-bold hover:text-corporate-red transition-colors text-sm uppercase tracking-wider group"
          >
